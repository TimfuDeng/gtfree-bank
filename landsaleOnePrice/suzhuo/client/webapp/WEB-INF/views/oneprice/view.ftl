                        ...
                        <tbody>
                                ...
                                <#if (((nowDate?long)-(oneTarget.priceEndDate?long)) lte 0)><#--//判断是否结束;结束时间小于现在时间对比-->
                                    ...
                                    <#if transUserId??><#--//判断是否登录-->
                                                ...
                                                <#if transLicense?? && transLicense.status==1><#--//判断是否有资格购买-->
                                                    ...
                                                    <#else><#--//询问期-->
                                                        ...
                                                        <tr class="price price-disable">
                                                            <td class="value" style="color: #d91615; text-align: center" colspan="2">
                                                                <p style="line-height:80px;font-size:15pt;font-weight: bold;"> 您已经具有竞买资格</p>
                                                            </td>
                                                        </tr>
                                                        <#else>
                                                        <tr class="price price-disable">
                                                ...
                                                <tr >
                                                    <td colspan="2" style="text-align: center">
                                                        ...
                                                        <p style="line-height:80px;font-size:15pt;font-weight: bold;"> 您无竞买资格</p>
                                                    </td>
                                                </tr>

                                                </#if>
                                            <#else>
                                                <a class="btn btn-secondary size-L" style="width: 236px" href="/client/oneprice/login">请登录</a>
                                            </#if>
        ...
        <table class="table table-price">
            ...
            <#if oneTarget?? && oneTarget.successPrice?? &&(oneTarget.successPrice gt 0)><#--//地块成交-->
                ...
                <#else><#--//地块成交-是在公开出让系统里面成交-->
                    <#list transResultLogList as transResultLog>
                        <tr>
                            <td style="width: 63%;text-align: center;">${transResultLog.PRICEUNIT!}</td>
                            <td style="text-align: center;">${transResultLog.PRICE!}</td>
                        </tr>
                    </#list>
                </#if>
