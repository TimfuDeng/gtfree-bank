    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <#list oneApplyList.items as oneApply>
            ...
            <td style="text-align: center">
                ...
                <#if ResultUtil.isCurrentUser(oneTarget.transUserId)><!-- 判断是否是竞得人 -->
                    <p style="margin-bottom:3px"><a class="btn btn-primary size-MINI" style="width:180px" href="${base}/oneprice/my/cjtzs.f?id=${oneTarget.id!}">成交通知书&gt;&gt;&gt;</a></p>
                </#if>
