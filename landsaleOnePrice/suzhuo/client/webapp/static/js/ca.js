var gtmapCA = (function(windows,$,undefined){
     ...
     * @private
     */
    var _getCertificateSerialNumber=function(){
        _getCertificate(_certId);
    ...
    /**
     * 获取当前证书的用户Id（身份证号或组织机构代码）
     * @returns {*}
     */
    var _getCertificateId=function(){
        _getCertificate(_certId);
        var userName = '';
        var friendlyName = _certificate.FriendlyName;
        userName +=friendlyName;
    ...
    return{
        ...
        getCertificateSerialNumber:_getCertificateSerialNumber,
