...
public class SqlString {
	...
	public static HashMap<String,Object> queryTest(){
		//String condition = "XZQ_DM='"+xzq+"' AND TBRQ='"+tbrq+"'";
		String condition = "resource_id='015c3d97d859802962785c3aa928015c'";
		HashMap<String,Object> parametersMap = SqlString.genParameterMap("*", "trans_resource", condition);
