...
<div class="pm-addition">
    ...
    <div class="tabCon ">
                            ...
                            <#if attachments??>
                                <#list attachments as attachment>
                                    <#if attachment.fileType==key>
                                        <a title="${attachment.fileName!}" class="btn btn-link attachment" target="_blank" href="${core}/transfile/get?fileId=${attachment.fileId}">${attachment.fileName!}</a>
                                    </#if>
                                </#list>
                            </#if>
                        </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <#list crggAttachments as crggAttachment>
                            <a title="${crggAttachment.fileName!}" class="btn btn-link attachment" target="_blank" href="${core}/transfile/get?fileId=${crggAttachment.fileId}">${crggAttachment.fileName!}</a>
                        </#list>
                        </div>
                    </td>
                </tr>
        ...
        <div class="tCon">
            <iframe src="${base}/view/offer/list?resourceId=${resource.resourceId!}" width="100%" height="700px"
