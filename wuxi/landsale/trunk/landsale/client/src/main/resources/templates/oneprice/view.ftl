...
<#--<link rel="stylesheet" href="${base}/js/dist/view_201611070805.css" />-->
</head>
<body>
<script>
...
<div class="wp">
    ...
    <#--<span class="c_gray en">&gt;</span>-->
        <span class="c_gray "  >${oneTarget.transName!}</span>
    </nav>
                ...
                <div class="col-12" style="background:#f5f5f5; margin-top:20px; ">
                    <div class="row cl" style="">
                        <table class="table table-offer" style="-moz-user-select:none;font-size:14px;" onselectstart="return false">
                            <tbody>
                            <#--判断是否发布-->
                            <#if oneTarget?? && oneTarget.isStop==1>
                                <#--//判断是否未结束;结束时间小于现在时间对比-->
                                <#if (((nowDate?long)-(oneTarget.priceEndDate?long)) lte 0)>
                                    <#--//判断是否登录-->
                                    <#if transUserId??>
                                        <#--//判断是否有资格购买&& (transOfferCount gt 0)-->
                                        <#if (resourceApply?? && resourceApply.applyStep==4) >
                                            <#--当前时间在 报价时间 内-->
                                            <#if (((nowDate?long)-(oneTarget.priceBeginDate?long)) gt 0)  &&(((nowDate?long)-(oneTarget.priceEndDate?long)) lte 0)>
                                                <#--已经报价-->
                                                <#if myOnePriceLog??>
                                                    <tr>
                                                    ...
                                                    <tr class="price price-disable"  >
                                                        ...
                                                        <td style="text-align: right">
                                                            ...
                                                            <em class="price-font-small" id="priceInfo" style="letter-spacing:30px">
                                                            ${oneTarget.priceMin!}
                                                            </em>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr class="price price-disable">
                                                        <td class="value" style="text-align: center" colspan="2">
                                                            ...
                                                            <p style="line-height:80px;font-size:15pt;font-weight: bold;">您已报价成功，报价为：${myOnePriceLog.price!}元</p>
                                                        </td>
                                                    </tr>
                                            <#--未报价；-->
                                            <#else>
                                                        ...
                                                        <td  style="color: #0684CE;">
                                                            <table class="table table-border table-bordered table-money">
                                                                ...
                                                                <tr class="one-price" >
                                                                    ...
                                                                    <td><input id="qian" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                    <td><input id="bai" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                    <td><input id="shi" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                    <td><input id="yuan" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                </tr>
                                                            </table>
                                                        ...
                                                        <td  style="color: #0684CE;">
                                                            <table class="table table-border table-bordered table-money">
                                                                ...
                                                                <tr class="one-price" >
                                                                    ...
                                                                    <td><input id="qianValid" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                    <td><input id="baiValid" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                    <td><input id="shiValid" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                    <td><input id="yuanValid" class="input-text" type="text" min="0" max="9" onpaste="return false;" onchange="keyPress(this)"  maxlength="1" /> </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                        ...
                                        <#--//询问期-->
                                        <#elseif (((nowDate?long)-(oneTarget.queryBeginDate?long)) gt 0) &&(((nowDate?long)-(oneTarget.queryEndDate?long)) lte 0)>
                                            <tr>
                                        ...
                                        <#--等待期-->
                                        <#elseif (((nowDate?long)-(oneTarget.waitBeginDate?long)) gt 0) &&(((nowDate?long)-(oneTarget.waitEndDate?long)) lte 0)><#--是否在等待-->
                                            <tr>
                                ...
                                <#else>
                                <#--//结束-已经成交-->
                                <#if oneTarget?? && oneTarget.successPrice?? &&(oneTarget.successPrice gt 0)>
                                    <tr class="price price-disable"  >
                                        <td style="color: #0684CE;">
                                            报价必须大于(元)：
                                        </td>
                                    ...
                                    <tr >
                                        <td colspan="2" style="text-align: center">
                                            <p style="line-height:40px;font-size:12pt;font-weight: bold;">
                                                ...
                                                竞得价： ${oneTarget.successPrice!}元<br>
                                                平均价： ${oneTarget.priceAvg!}元
                                            </p>
                            ...
                            <#else>
                                <tr class="price price-disable">
                                    <td  class="value" style="color: #0684CE; text-align: center" colspan="2">
                                        <p style="line-height:80px;font-size:15pt;font-weight: bold;">一次报价未发布,不可以进行一次报价</p>
                                    </td>
                                </tr>
                            </#if>
                            </tbody>
...
<script id="tpl_beginoffer" type="text/html">
    <div style="text-align: center">
        <p style='color: #0684CE;font-size: 20px'>小写：<span id="spanOffer">{{ d.offer }}</span>元</p>
...
<script type="text/javascript" src="${base}/js/oneprice/view.js"></script>
