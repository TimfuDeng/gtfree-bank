    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <#list oneApplyList.items as oneApply>
            ...
            <td style="text-align: center">
                ...
                <p style="margin-bottom:3px"><a class="btn btn-primary size-MINI" style="width:180px" href="${base}/oneprice/my/view-offer-list?id=${oneTarget.transResourceId!}">查看结果&gt;&gt;&gt;</a></p>
