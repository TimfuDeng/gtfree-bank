...
<div  class="search_bar">
    <form class="navbar-form" id="frmSearch">
        <div class="l">
            ...
            <a class="btn btn-primary" type="button" target="_self" href="${base}/resource/view/offer/list?resourceId=${resourceId!}">刷新</a>
        </div>
    </form>
</div>
<div>
    ...
    <table class="table table-border">
        ...
        <tr>
            <td class="offerText">${resourceOffer.offerTime?datetime?string('yyyy年MM月dd日 HH:mm:ss')}</td>
            <td>
