...
<body>
	<div class="tb_main">
    	<div class="tb_main_up">
        	...
        	<div class="tb_main_up_left">
            	<div class="tb_main_up_left_title">
                    ...
                    <#elseif resource.resourceStatus == 3>
                        <p>已中止</p>
                    <#elseif resource.resourceStatus == 4>
                        <p>已终止</p>
                    <#else>
                        <p>未开始</p>
                    </#if>
                 ...
                 <ul>
                    ...
                    <li>
                        ...
                        <#if resource.resourceStatus==2 || resource.resourceStatus==10 || resource.resourceStatus=11>
                            <p>当前价：</p>
                            <em class="currency" >¥</em>
                            <span style="font-weight:bold;" id="priceInfo">
                                <#if maxOfferPrice??>
            ...
            <div class="tb_main_up_right">
                ...
                <ul>
                    <li>
                    	<p>起始价：</p>
                        <span>¥${resource.beginOffer!}&nbsp;万元</span>
                    </li>
                    <li>
                    	<p>增价幅度：</p>
                ...
                <#if resource.resourceEditStatus == 2 || resource.resourceEditStatus == 9>
                    ...
                    <#if resource.resourceStatus==10 || resource.resourceStatus==1>
                        ...
                        <#if (((resource.gpEndTime?long)-(.now?long)) lt 1000*60*60) && (((resource.gpEndTime?long)-(.now?long)) gt 0)>
                            ...
                            <span style="height:25px;line-height:25px;margin: 44px 0 0 10px;" class="label label-warning"> 挂牌截止前1小时停止报价，限时开始时间后进入4分钟限时竞价！</span>
                        <#--竞价期之前挂牌期之后-->
                        <#elseif ((resource.xsBeginTime?long)-(.now?long) lt 0) && ((resource.gpEndTime?long)-(.now?long) gt 0)>
                            <input class="btn btn-default size-L" type="button" value="停止报价" style="width: 145px" />
                            <span style="height:25px;line-height:25px;margin: 44px 0 0 10px;" class="label label-warning"> 限时开始时间前停止报价，限时开始时间后进入4分钟限时竞价！</span>
                        <#else>
                            <input onclick="beginOffer();" class="btn btn-primary size-L" type="button" value="报&nbsp;&nbsp;&nbsp;&nbsp;价" style="width: 145px" />
                            <div id="showinfo" style="margin:40px 0 0 10px;padding:0px;float: left;width:230px"></div>
                        </#if>
                    <#--地块状态为公告期-->
                    ...
                    <#elseif resource.resourceStatus==11>
                        <input class="btn btn-default size-L" type="button" value="停止报价" style="width: 145px" />
                        <span style="height:25px;line-height:25px;margin: 44px 0 0 10px;" class="label label-warning">已达到最该限价,等待限时开始时间后进入下一步！</span>
                    <#--成交或流拍-->
                    <#else>
                        <input class="btn btn-default size-L" type="button" value="停止报价" style="width: 145px" />
                        <span style="height:25px;line-height:25px;margin: 44px 0 0 10px;" class="label label-warning">已结束</span>
                    </#if>
                    <#--<p style="color:#e66b6b">即将开始</p>-->
                <#else>
                    <input class="btn btn-default size-L" type="button" value="停止报价" style="width: 145px" />
                </#if>
            </div>
        ...
        <div class="tb_main_middle_title" style="margin:20px auto 0 auto;">
            	<img src="${base}/images/front_03.png">
                <p>竞价记录</p>
            </div>
        <table width="1138" style="margin:0 auto;  line-height:39px;" border="0" cellpadding="0" cellspacing="0">
