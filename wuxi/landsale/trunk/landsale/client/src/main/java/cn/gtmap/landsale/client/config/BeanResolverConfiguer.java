...
public class BeanResolverConfiguer extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        secContextInterceptor.setExcludes(new String[] {"/login", "/logout", "/file/**", "/report/**", "/", "/getRegion", "/index", "/resource/index", "/resource/content", "/resource/view/**","/resource/resourceNotice", "/notice/**", "/material/**", "/help", "/error"});
