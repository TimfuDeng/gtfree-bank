...
public interface TransResourceOfferService {
     ...
     * @return
     */
    ResponseMessage<TransResourceOffer> addTransResourceOffer(TransResourceOffer offer);
     ...
     * @return
     */
    List<TransResourceOffer> findTransResourceOfferByOfferPrice(double offerPrice,String resourceId);
