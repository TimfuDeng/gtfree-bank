...
(function ($) {
    /*console.info($.fn.ajaxForm);
    console.info(basePath);*/
    if(isEmpty($.fn.ajaxForm)) {
        /*console.info($.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "malsup.github.io/jquery.form.js"));
        console.info($.getScript(basePath + "/js/upload/jquery.form.js"));*/
        $.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "malsup.github.io/jquery.form.js");
        /*$.getScript(basePath + "/js/upload/jquery.form.js");*/
    }
    var feature = {};
    ...
    $.fn.uploadFile = function (options) {
        ...
        this.errorLog = $("<div style='float: left;'></div>"); //Writing errors
        this.responses = [];
