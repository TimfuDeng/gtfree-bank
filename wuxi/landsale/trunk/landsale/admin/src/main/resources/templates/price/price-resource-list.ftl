...
<table class="table table-border table-bordered" >
    ...
    <tr class="text-c" style="background-color: #f5f5f5">
        ...
        <th style="width:190px">挂牌截止时间</th>
    ...
    <tr>
        ...
        <td style="text-align: center">
            <p>
                <em style="font-weight: 700;font-family: verdana;font-style: normal;text-align: center;color: #3c3c3c;">
                    ...
                    ${maxResourceOffer.offerPrice?string("0.####")}<span class="unit_span"><@unitText value=resource.offerUnit! /></span>
                    </#if>
                </em>
            </p>
        </td>
        <td style="text-align: center">
            ...
            <p>
                ...
                <em style="font-weight: 700;font-family: verdana;font-style: normal;text-align: center;color: #3c3c3c;">
                    ...
                    <#if minPrice gt 0>
                    ${minPrice?string("0.####")}<span class="unit_span"><@unitText value=resource.offerUnit! /></span>
                    <#else>
        ...
        <td style="text-align: center">
            <a class="btn btn-primary size-S" href="javascript:changeSrc('${base}/price/edit?resourceId=${resource.resourceId!}')">底价录入</a>
        </td>
    </tr>
    </#list>
    </tbody>
