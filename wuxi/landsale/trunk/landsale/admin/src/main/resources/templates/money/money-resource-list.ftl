...
<table class="table table-border table-bordered" >
    ...
    <#list transResourcePage.items as resource>
        <tr>
            <td>
                <div class="l">
                    <a href="javascript:changeSrc('${base}/resource/view?resourceId=${resource.resourceId!}')" >
                        ...
                        <div>
                            <#if resource.resourceLocation?length gt 14>
            ...
            <td style="text-align: center">
                <a class="btn btn-primary size-S" href="javascript:changeSrc('${base}/money/money-list?resourceId=${resource.resourceId!}')">保证金列表</a>
            </td>
        </tr>
    </#list>
    </tbody>
