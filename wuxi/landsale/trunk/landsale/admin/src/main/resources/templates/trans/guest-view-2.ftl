...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${base}/thridparty/slidebar/layout.css">
    <link type="text/css" rel="stylesheet" href="${base}/thridparty/slidebar/jquery.mmenu.all.css">

    <script type="text/javascript" src="${base}/thridparty/H-ui.2.0/lib/jquery.min.js"></script>
    <script type="text/javascript" src="${base}/js/jquery.SuperSlide.2.1.1.source.js"></script>
    <script type="text/javascript" src="${base}/thridparty/artTemplate/template.js"></script>
    ...
    <script type="text/javascript" src="${base}/thridparty/slidebar/jquery.mmenu.min.all.js"></script>
    ...
    <script type="text/javascript" src="${base}/thridparty/slidebar/layout.js"></script>
                ...
                <div>
                    <div style="float:left;width: 50%;">
                        ...
                        <div>
                            ...
                            <div class="showInfo">
                                <div style="float: left;">规划用途：{{resource.tdytName}}</div>
