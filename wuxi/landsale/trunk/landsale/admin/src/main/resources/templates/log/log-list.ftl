...
<div  class="search_bar">
    ...
    <form class="navbar-form" id="frmSearch">
        <div class="l">
            ...
            <span 时间：</span>
            <input type="text" id="beginTime" name="beginTime" class="input-text Wdate" value="<#if beginTime?? && beginTime!''>${beginTime?datetime}</#if>" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
            -<input type="text" id="endTime" name="endTime" class="input-text Wdate" value="<#if endTime?? && endTime!''>${endTime?datetime}</#if>" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd HH:mm:ss'})">
...
<#list transAuditLogList.items as log>
    <tr>
        ...
        <td style="width: 150px">
            <a href="javascript:changeSrc('${base}/log/content?auditId=${log.auditId!}')" class="btn btn-default size-S" >查看内容</a>
        </td>
    </tr>
</#list>
</table>
