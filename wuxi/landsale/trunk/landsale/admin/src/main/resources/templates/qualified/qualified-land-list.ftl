    ...
    <tr class="order-bd">
        ...
        <#-- <a style="float: left;padding-left:25px">
            ...
            <div class="l" style="width: 390px;">
                <a href="javascript:changeSrc('${base}/resource/view?resourceId=${transResource.resourceId!}')" >
                    ...
                    <br><span>保证金：人民币${transResource.fixedOffer?string("0.######")}万元<#if transResource.fixedOfferUsd??>，美元${transResource.fixedOfferUsd?string(",##0.######")}万美元</#if><#if transResource.fixedOfferHkd??>，港币${transResource.fixedOfferHkd?string(",##0.######")}万港币</#if>&nbsp;&nbsp;
        ...
        <td style="text-align: center">
            <div id="div_status_${transResource.resourceId!}" style="margin-top: 2px">
                ...
                <a   href="javascript:changeSrc('${base}/qualified/resourceApply?resourceId=${transResource.resourceId!}')" class="btn btn-primary">竞买人审核</a>
