...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkForm(){
            checkInputFileter();
            if (!checkInputNull('ggTitle','中止(终止)公告标题必须填写!')) {
                return false;
...
<form class="form-base" method="post">
    <table class="table table-border table-bordered table-striped">
        <tr>
            ...
            <td><input type="text" class="input-text"  name="ggTitle" value="${suspendNotice.ggTitle!}"
                                   style="width:100%;background-color: #FFFFCC" maxlength="100" readonly="readonly"></td>
        ...
        <tr>
            ...
            <td><input type="text" class="input-text" name="ggNum" value="${suspendNotice.ggNum!}"
                       style="width:100%;;background-color: #FFFFCC" maxlength="32" readonly="readonly"></td>
            ...
            <td>
                ...
                <#else>
                    <input type="text" readonly="readonly" class="input-text" name="resourceCode" value="${suspendNotice.resourceCode!}" style="width:100%;;background-color: #FFFFCC" maxlength="32">
                </#if>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea disabled="disabled" type="text" id="noticeContent" name="noticeContent" class="xheditor" style="width: 100%;;background-color: #FFFFCC"
    ...
    <input type="hidden" id="noticeId" name="noticeId" value="${suspendNotice.ggId!}"/>
    <input type="hidden" id="deployStatus" name="deployStatus" value="${suspendNotice.crggStauts!}"/>
