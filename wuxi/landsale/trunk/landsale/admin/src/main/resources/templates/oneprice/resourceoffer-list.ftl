...
<nav class="breadcrumb">
    ...
    <a href="javascript:changeSrc('${base}/resource/list')" class="maincolor">首页</a>
...
<#if oneTarget??>
      ...
      lt ((nowDate?string("yyyy-MM-dd HH:mm:ss"))? date("yyyy-MM-dd HH:mm:ss")))>
            <a href="${base}/oneprice/offerlist-excel?id=${oneTarget.transResourceId!}" class="btn btn-primary">导出Excel</a>
