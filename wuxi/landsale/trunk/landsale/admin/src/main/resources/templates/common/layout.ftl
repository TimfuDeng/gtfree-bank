...
<#--<script type="text/javascript" src="${base}/static/thridparty/H-ui.2.0/lib/bootstrapSwitch/bootstrapSwitch.js"></script>-->
<#--<script type="text/javascript" src="${base}/static/thridparty/H-ui.2.0/lib/Validform_v5.3.2.js"></script>-->
<#--<script type="text/javascript" src="${base}/static/thridparty/H-ui.2.0/lib/passwordStrength-min.js"></script>-->
