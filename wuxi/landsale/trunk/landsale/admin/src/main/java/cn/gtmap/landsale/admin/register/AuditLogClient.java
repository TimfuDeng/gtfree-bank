...
public interface AuditLogClient {
    ...
    Page<TransAuditLog> findTransAuditLogs(@RequestParam(value = "beginTime",required = false) String beginTime,
                                           @RequestParam(value = "endTime",required = false) String endTime,
                                           @RequestParam(value = "producer",required = false) String producer,
                                           @RequestParam(value = "category",required = false) String category, @RequestBody Pageable request);
