...
public interface TransCrggClient {
     ...
     * @return  新的出让公告对象
     */
    @RequestMapping(value = "/crgg/updataTransCrgg", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    ResponseMessage<TransCrgg> updataTransCrgg(@RequestBody TransCrgg transCrgg);
     ...
     * @return
     */
    @RequestMapping(value = "/crgg/deleteSuspendCrgg",method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return 出让公告对象
     */
    @RequestMapping(value = "/crgg/findTransCrggByGgType",method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return 出让公告对象
     */
    @RequestMapping(value = "/crgg/findSuspendNotice",method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
