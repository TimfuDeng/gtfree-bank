...
public interface TransBuyQualifiedClient {
     ...
     * @return
     */
    @RequestMapping(value = "/qualified/getTransBuyQualifiedById", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    TransBuyQualified getTransBuyQualifiedById(@RequestParam(value = "qualifiedId") String qualifiedId);
