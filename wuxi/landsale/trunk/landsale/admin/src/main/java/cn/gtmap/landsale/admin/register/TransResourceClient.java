...
public interface TransResourceClient {
    ...
    ResponseMessage updateTransResourceDisplayStatus(@RequestParam("resourceId") String resourceId, @RequestParam("displayStatus") int displayStatus);
     ...
     * @return
     */
    @RequestMapping(value = "/resource/getResourcesByCode", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    List<TransResource> getResourcesByCode(@RequestParam("resourceCode") String resourceCode);
     ...
     * @return
     */
    @RequestMapping(value = "/resource/findYhResourcesByEditStatus", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    Page<TransResource> findYhResourcesByEditStatus(@RequestParam(value = "title",required = false) String title,@RequestParam(value = "status",required = false) int status,@RequestParam(value = "ggId",required = false) String ggId,@RequestParam(value = "regionCodes",required = false) String regionCodes,@RequestBody Pageable request);
     ...
     * @return
     */
    @RequestMapping(value = "/resource/findYCBJResourcesByEditStatus", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    Page<TransResource> findYCBJResourcesByEditStatus(@RequestParam(value = "title",required = false) String title,@RequestParam(value = "status",required = false) int status,@RequestParam(value = "ggId",required = false) String ggId,@RequestParam(value = "regionCodes",required = false) String regionCodes,@RequestBody Pageable request);
     ...
     * @return
     */
    @RequestMapping(value = "/resource/getTransResourcesOnRelease", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
     ...
     * @return
     */
    @RequestMapping(value = "/resource/findDealTransResourcesByEditStatus", method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
    Page<TransResource> findDealTransResourcesByEditStatus(@RequestParam(value = "title",required = false) String title, @RequestParam(value = "status",required = false) int status, @RequestParam(value = "resourceStatus",required = false) int resourceStatus, @RequestParam(value = "ggId",required = false) String ggId, @RequestParam(value = "regionCodes",required = false) String regionCodes, @RequestBody Pageable request);
