...
<head>
    ...
    <style>
        ...
        .table_list TD A {
            COLOR: #ff0000; TEXT-DECORATION: underline ;FONT-SIZE: 90%;
        }
        .table_list TH {
    ...
    <div style="text-align: center;padding-top: 30px">
        <table class="table_list" cellspacing="1" cellpadding="1" align="center" style="table-layout:fixed">
            <tr class='contentRowLight'>
                ...
                <th style="width:13%;text-align: center"> 起始价</th>
                <th style="width:13%;text-align: center;"> 成交时间</th>
                <th style="width:30%;text-align: center;"> 竞得人</th>
                <th style="width:19%;text-align: center;"> 成交价</th>
        ...
        <#list transResourceList.items as transResource>
            ...
            <tr class='contentRowLight'>
                <td style="width:180px;text-align: center;overflow:hidden;white-space:nowrap;"><a target="_blank" href="/view/resource/index?id=${transResource.resourceId}">${transResource.resourceCode!}</a></td>
                <td style="text-align: center;">${transResource.beginOffer!}万元</td>
                <td style="text-align: center;">${(transResource.overTime!)?string("yyyy-MM-dd")}</td>
