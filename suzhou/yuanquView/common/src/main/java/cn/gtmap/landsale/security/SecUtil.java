...
public class SecUtil {
    ...
    final static String USER_REGION_DEPTS="_USER_REGION_DEPT_CODE";
    ...
    public static void setLoginUserToLocal(TransUser transUser){
        ...
        if (StringUtils.isNotBlank(privileges)) {
            ...
            if(privilegeMap.containsKey("regionDepts"))
                SecurityContext.getContext().getAttr().setAttr(USER_REGION_DEPTS,Sets.newHashSet((List)privilegeMap.get("regionDepts")));
    ...
    private static void clearContextAttr(boolean isClearAll){
        ...
        SecurityContext.getContext().getAttr().removeAttr(USER_REGION_DEPTS);
        if(isClearAll)
    ...
    public static Set<String> getPermittedRegions(){
        String regions = SecurityContext.getContext().getAttr().getAttr(USER_REGION_DEPTS,String.class,null);
