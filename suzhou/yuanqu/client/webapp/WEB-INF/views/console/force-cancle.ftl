...
<div class="wp">
    <nav class="breadcrumb pngfix">
        ...
        <span class="c_gray en">&gt;</span><a href="${base}/view?id=${transBuyQualified.resourceId}">强制退回并查看原因</a>
    </nav>
<#if _msg??>
    ...
    <div class="row">
        ...
        <div style="text-align: center;margin-top: 20px">
            <a class="btn btn-danger size-L"  style="width: 236px" href="${base}/console/apply-bzj?id=${resource.resourceId}">保证金账户</a>
        </div>
    </div>
