...
<head>
    ...
    <meta charset="utf-8">
    <title>苏州工业园区国有建设用地使用权网上出让系统 - ${_title!}</title>
...
<#macro LandUseConvert selectValue>
    ...
    <#if selectValue?? && selectValue=="062" >采矿用地</#if>
    <#if selectValue?? && selectValue=="063" >仓储用地</#if>

    <#if selectValue?? && selectValue=="064" >工业</#if>
    <#if selectValue?? && selectValue=="065" >仓储</#if>
    <#if selectValue?? && selectValue=="066" >科教</#if>
    <#if selectValue?? && selectValue=="067" >工业(标准厂房)</#if>
    <#if selectValue?? && selectValue=="068" >工业(高标准厂房)</#if>
    <#if selectValue?? && selectValue=="069" >工业(研发)</#if>
    <#if selectValue?? && selectValue=="070" >工业(文化创意)</#if>
    <#if selectValue?? && selectValue=="071" >工业(总部经济)</#if>
    <#if selectValue?? && selectValue=="072" >科教(研发)</#if>
    <#if selectValue?? && selectValue=="073" >科教(文化创意)</#if>
    <#if selectValue?? && selectValue=="074" >科教(总部经济)</#if>
