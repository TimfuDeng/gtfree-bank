...
<div class="pm-addition">
    ...
    <div class="tabCon ">
            ...
            <div class="row">
                <table class="table table-border table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="3">${resource.bidType!}</td>
                    </tr>
                    <tr>
        ...
        <#if resource.regionCode!="320503001">
            <div class="tCon">
                <iframe src="${base}/view/oneprice/offer/list.f?resourceId=${resource.resourceId!}" width="100%" height="700px"
                        frameborder="no" border="0" marginwidth="0" marginheight="0"></iframe>
            </div>
        </#if>
        ...
        <div class="tCon" style="height: 850px">
            ...
            src="http://58.210.9.131/DataCenter/WebApp/wsjy/index.aspx?zdh=${resourceCodeSecret!}"
            </div>-->
