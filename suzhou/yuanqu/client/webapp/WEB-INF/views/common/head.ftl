<div class="topbar">
    <div class="cl wp">
        <span class="topLeft l">
          <a class="active" href="${base}/index/type">首页</a>
            <a href="${base}/material?regionCode=320503001">工业用地-资料下载</a>
             <a href="${base}/material?regionCode=320503002">经营用地-资料下载</a>
        ...
        <div class="topLeft r">
            <#if WebUtil.isLogin()>
                ...
                <a  href="${base}/my/resource-list" id="aUser" value="${WebUtil.loginUserId!}">
                    ...
                    <#if (applyCount gt 0)|| (applyedCount gt 0)>
                    <span class="label label-success radius" style="width:15px!important;text-align: center;">${applyCount+applyedCount}</span>
                    </#if>
                </a>
