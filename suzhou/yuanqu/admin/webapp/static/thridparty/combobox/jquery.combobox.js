...
(function($) {
    ...
    $.fn.combobox = function(suggestions, config) {
        //config = $.extend({ imageUrl: baseUrl + '/static/thridparty/combobox/dropdown.gif' }, config);
        config = $.extend({ imageUrl: config.baseUrl + '/static/thridparty/combobox/dropdown.gif' }, config);
        if(!optionsContainer) {
