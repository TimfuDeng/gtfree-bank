...
<#if resourceApply.applyStep==2>
    <a   href="${base}/console/qualified/verify?applyId=${resourceApply.applyId!}&&resourceId=${resourceId}" class="btn size-S btn-primary">审核</a>
    <#--<input class="btn size-S btn-secondary" type="button" value="退回" onclick="BackEdit('${resourceApply.applyId!}')">-->
    <a   href="${base}/console/qualified/verify/list?applyId=${resourceApply.applyId!}" class="btn size-S btn-primary">历史记录</a>
