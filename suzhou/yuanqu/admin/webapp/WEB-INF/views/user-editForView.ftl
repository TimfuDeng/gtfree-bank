...
<nav class="breadcrumb pngfix">
    ...
    <span class="c_gray en">&gt;</span><a href="${base}/console/user/list?userType=0">竞买人注册</a>
...
<form class="form-base" method="post" action="${base}/console/user/front/save">
    <table class="table table-border table-bordered table-striped">
        ...
        <tr>
            ...
            <td><input type="text" class="input-text" id="userName"  name="userName" placeholder="登录名" value="${transUser.userName!}" style="width:100%;background-color: #ffffcc" maxlength="200"></td>
            <td><label class="control-label">证件号：</label></td>
            <td><input type="text" class="input-text" placeholder="证件号" id="certificateId" name="certificateId" value="${transUser.certificateId!}" style="width:100%;background-color: #ffffcc" maxlength="32"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" class="input-text" id="viewName" name="viewName" placeholder="姓名" value="${transUser.viewName!}" style="width:100%;background-color: #ffffcc" maxlength="200"></td>
        ...
        <tr>
            ...
            <td width="300"><@SelectHtml SelectName="regionCode" SelectObjects=regionAllList Width=0 SelectValue=transUser.regionCode onChange="" /></td>
            <td></td>
            <td></td>
        </tr>
    ...
    <div class="row-fluid">
        <div class="span10 offset2">
            ...
            <button type="button" class="btn" onclick="window.location.href='${base}/console/user/list?userType=0'">返回</button>
        </div>
    </div>
</form>
<@Ca autoSign=0  />
