...
<nav class="breadcrumb pngfix">
    ...
    <span class="c_gray en">&gt;</span><a href="${base}/console/suspendNotice/list">中止公告</a>
</nav>
...
<form class="form-base" method="post" action="${base}/console/suspendNotice/save">
    <table class="table table-border table-bordered table-striped">
        <tr>
            <td width="120"><label class="control-label">中止公告标题：</label></td>
        ...
        <tr>
            ...
            <td><input type="text" class="input-text" name="resourceCode" value="${suspendNotice.resourceCode!}"
                       style="width:100%" readonly="true"></td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="deployTime" value="${(suspendNotice.deployTime!)?string("yyyy-MM-dd HH:mm:ss")}" class="input-text" readonly="true"/>
            </td>
        </tr>
    <#--
    ...
    -->
        <tr>
            <td><label class="control-label">中止公告详情：</label></td>
            <td colspan="3">
    ...
    <div class="row-fluid">
        <div class="span10 offset2">
            <button type="button" class="btn btn-primary" onclick="window.location.href='${base}/console/suspendNotice/list'">返回</button>
        </div>
    </div>
</form>
