    ...
    <#if transResourceApply.applyType??&&transResourceApply.applyType==1&&transUserUnionList??>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="radio" name="qualifiedStatus" value="0" <#if transBuyQualified?? && transBuyQualified.qualifiedStatus==0 >checked="true" </#if> />否
            </td>
            <td width="180px"><lable class="control-label">选择银行：</lable></td>
            <td width="300px">
