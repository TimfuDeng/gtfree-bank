...
<nav class="breadcrumb pngfix">
    ...
    <span class="c_gray en">&gt;</span><a href="${base}/console/qualified/verify/list?applyId=${transResourceApply.applyId!}">审核列表</a>
...
<form class="form-base" method="post" action="${base}/console/qualified/verify/save">
    <table class="table table-border table-bordered table-striped">
        ...
        <tr>
            ...
            <td width="300px">
                <input type="text" name="qualifiedTime" class="input-text Wdate"
                       disabled="disabled"   value="${transBuyQualified.qualifiedTime?string("yyyy-MM-dd HH:mm:ss")}">
            </td>
        ...
        <tr>
            ...
            <td>
                ...
                <input disabled="disabled" type="radio" name="qualifiedStatus" value="0" <#if transBuyQualified?? && transBuyQualified.qualifiedStatus==0 >checked="true"</#if> />：否
            </td>
    ...
    <#if transBuyQualified?? && transBuyQualified.qualifiedStatus==0 >
        <tr>
            <td><label class="control-label">联系方式：</label></td>
            <td colspan="3">
