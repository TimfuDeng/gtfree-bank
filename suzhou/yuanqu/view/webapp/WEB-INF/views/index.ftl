            ...
            <tr>
                ...
                <td class="va-m">
                    ...
                    <span class="label <@OutClassValue obj=param.useType! value='GKCCYD' classValue='label-danger' defaultValue='label-none'/>">
                     ...
                     <span class="label <@OutClassValue obj=param.useType! value='ZZYD,SFYD' classValue='label-danger' defaultValue='label-none'/>">
                         <a href="#" onclick="submitValue('useType','ZZYD,SFYD')">
                             商住
                         </a>
                    </span>
