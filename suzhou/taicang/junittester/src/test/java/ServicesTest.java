...
public class ServicesTest {
	...
	@Autowired
	private OnePriceLogService onePriceLogService;

	@Test
	public void testTransUserService(){
		TransUser transUser = transUserService.getTransUserByKeyInfo("凡甲?子(?州)有限公司91320585745550031E", "");
		System.out.println(transUser.getCaName());
	}

	@Test
	public void testOnePriceLogService(){
		OnePriceLog onePriceLog = onePriceLogService.findOnePriceLogListByTransTargetIdTransUserId("01598bf3997908f5e0e7598bef1d0003", "0159814b22ce01664b9a5981439e001e");
		for (int i = 1; i < 100; i++) {
			OnePriceLog onePriceLogTemp = new OnePriceLog();
			BeanUtils.copyProperties(onePriceLog,onePriceLogTemp);
			onePriceLogTemp.setTransUserId(cn.gtmap.egovplat.core.util.UUID.hex32());
			onePriceLogTemp.setId(null);
			onePriceLogTemp.setPrice(onePriceLogTemp.getPrice()+i);
			onePriceLogService.saveOnePriceLog(onePriceLogTemp);
		}
	}
