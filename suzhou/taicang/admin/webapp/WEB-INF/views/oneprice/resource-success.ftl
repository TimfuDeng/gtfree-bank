...
<form class="form-base" method="post" action="${base}/oneprice/resource/success/save">
    <table class="table table-border table-bordered table-striped">
        ...
        <tr>
            ...
            <td width="180"><label class="control-label">平均报价（万元）：</label></td>
        ...
        <tr>
            ...
            <td><label class="control-label">竞得价（万元）：</label></td>
            <td >
        ...
        <table class="table table-border table-bordered">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"  width="280">报价（万元）</td>
                ...
                <tbody>
                    <#list transResourceOfferList as transResourceOffer>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center">
                            ${(transResourceOffer.offerTime)?string("yyyy-MM-dd HH:mm:ss")}
                            </td>
                        </tr>
                        </#list>
                </tbody>
