...
<table class="table table-border table-bordered" >
    ...
    <#if oneParamList?? && oneParamList.items?? && oneParamList.items?size gt 0>
        <#list oneParamList.items as oneParam >
            <tr  class="text-c">
                ...
                <td style="text-align: center">
                    <a class="btn btn-primary size-S" href="${base}/oneprice/between/edit?id=${oneParam.id!}">参数修改</a>
                </td>
            </tr>
        </#list>
    <#else>
    <tr>
        <td colspan="4" style="text-align: center">
            <a class="btn btn-primary size-S" href="${base}/oneprice/between/edit">参数录入</a>
        </td>
    </tr>
    </#if>
    </tbody>
