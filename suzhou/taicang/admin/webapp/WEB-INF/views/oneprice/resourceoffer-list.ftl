...
<#if oneTarget??>
      ...
      lt ((nowDate?string("yyyy-MM-dd HH:mm:ss"))? date("yyyy-MM-dd HH:mm:ss")))>
            <a href="${base}/oneprice/offerlist-excel.f?id=${oneTarget.transTargetId!}" class="btn btn-primary">导出Excel</a>
            <table class="table table-border table-bordered table-striped table-bg ">
              ...
              <tr class="text-c">
                  ...
                  <th style="width:260px">报价(万元)</th>
                  <th style="width:260px">（报价减去平均价）差值(万元)</th>
              </tr>
              </thead>
              <tbody>
                  ...
                  <tr class="text-c">
                      <td colspan="2" class="text-c">合计(万元)：</td>
                      <td colspan="2" class="text-c">${totalPrice!}</td>
                  </tr>
                  <tr class="text-c">
                      <td colspan="2" class="text-c">平均价(万元)：</td>
