...
<form id="user_edit_form" class="form-base" method="post" action="${base}/console/user/save">
    <table class="table table-border table-bordered table-striped">
        ...
        <tr>
            ...
            <td><input type="text" class="input-text" id="userName"  name="userName" placeholder="登录名" value="${transUser.userName!}" style="width:100%"></td>
            <td><label class="control-label">密码：</label></td>
            <td><input type="password" class="input-text" placeholder="密码" name="password" value="${transUser.password!}" style="width:100%"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" class="input-text" id="viewName" name="viewName" placeholder="姓名" value="${transUser.viewName!}" style="width:100%"></td>
            <td><label class="control-label">编号：</label></td>
            <td><input type="text" class="input-text" name="userCode" placeholder="编号" value="${transUser.userCode!}" style="width:100%"></td>
        </tr>
        <tr>
            ...
            <td><input type="text" class="input-text" name="mobile" placeholder="手机号" value="${transUser.mobile!}" style="width:100%"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
                <textarea type="text" placeholder="描述" id="description" name="description" style="width: 100%" rows="5">${transUser.description!}</textarea>
            </td>
        </tr>
