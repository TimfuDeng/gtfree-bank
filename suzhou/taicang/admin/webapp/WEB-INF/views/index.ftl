...
<div style="margin-top: 20px">
    <div class="colBox colBoxNo1" >
        ...
        <div class="info-txt">当前共计：<span>${countGongGao+countGuaPai}</span>件</div>
    </div>
    <div class="colBox colBoxNo2">
        ...
        <div class="info-txt">已成交：<span>${countChengjiao!0}</span>件</div>
    </div>
    <div class="colBox colBoxNo3">
        ...
        <div class="info-txt">成交金额：<span>${sumOfDeal!0}</span>万元</div>
    </div>
    <#---->
    <#--<dl class="modList">-->
        <#--<dt>保证金明细</dt>-->
