				...
				<div id="div_status_${transItem.resourceId!}" style="margin-top: 2px ">
					...
					<div class="r">
						<#if transItem.displayStatus==0>
							<input type="button" onclick="updateDisplayStatus('${transItem.resourceId!}','1');" value="推送到大屏" class="btn size-S btn-success">
						<#else>
							<input type="button" onclick="updateDisplayStatus('${transItem.resourceId!}','0');" value="取消推送" class="btn size-S btn-danger">
						</#if>
					</div>
