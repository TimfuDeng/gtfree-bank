...
function initLeftResources(pageNum){
	...
	$.ajax({
		url: baseUrl + '/console/trans/view-resource/view_left',
		type: 'post',
		data: {
...
function initRightResources(){
	$.ajax({
		url: baseUrl + '/console/trans/view-resource/view_right',
		type: 'post',
		data: {
...
function updateDisplayStatus(resourceId,displayStatus){
	$.ajax({
		url: baseUrl + '/console/trans/list/status',
		type: 'post',
		data: {
...
function getResourceItem() {
	$.get(baseUrl + '/console/trans/resource', function (data) {
		dikuai = data;
		show();
