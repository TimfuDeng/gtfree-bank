...
function validateOnePrice(){
    var onePriceC="";//确认出价
    onePrice=1000000*$("#baiYi").val()+100000*$("#shiYi").val()+10000*$("#yi").val()+1000*$("#qianWan").val()
    +100*$("#baiWan").val()+10*$("#shiWan").val()+1*$("#wan").val();
    onePriceC=1000000*$("#baiYiValid").val()+100000*$("#shiYiValid").val()+10000*$("#yiValid").val()+1000*$("#qianWanValid").val()
    +100*$("#baiWanValid").val()+10*$("#shiWanValid").val()+1*$("#wanValid").val();
