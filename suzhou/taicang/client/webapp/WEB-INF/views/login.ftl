...
<div class="bodyBg">
    <div class="loginContent">
        ...
        <div class="LoginPosition">
            <div class="Login">
                <div id="normalLoginTab" class="loginForm">
                    ...
                    <#else>
                        ...
                        <div class="tip-btn">
                            <a class="btn-link" tabindex="7" href="/">门户</a>
                            <a class="btn-link tip-margin-left" tabindex="8" href="${base}/help">系统帮助</a>
                            <a class="btn-link tip-margin-left" tabindex="9" target="_blank" href="http://www.jsca.com.cn/servicedip/266.jhtml">行助手下载</a>
                        </div>
            ...
            <!-- 版权 -->
            <footer class="footer">
                <p class="Copyright">Copyright © 江苏省国土资源厅 版权所有 <a href="http://www.miibeian.gov.cn" target="_blank">${RegionUtil.getDefaultWebsiteICP()!}</a></p>
            </footer>
            <!--end 版权 -->
        </div>
