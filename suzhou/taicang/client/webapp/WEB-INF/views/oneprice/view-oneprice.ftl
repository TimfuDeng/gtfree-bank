                        ...
                        <div class="picbox">
                            <div id="featured">
                                <div class="image" id="image_pic-01">
                                    <img class="imageItem" src="${base}/static/image/blank.jpg" onerror="this.src='${base}/static/image/blank.jpg'" width="402" height="320">
                                </div>
                            </div>
                            <div id="thumbs">
                                <ul>
                                    <li id="play_prev" class="iconfont">󰅮</li>
                                    <li class="slideshowItem"><a id="thumb_pic-01" href="javascript:" class="current"><img src="${base}/static/image/blank.jpg" width="78" height="37" onerror="this.src='${base}/static/image/blank.jpg'"></a></li>
