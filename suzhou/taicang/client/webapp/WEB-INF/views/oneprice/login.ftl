...
<head>
    ...
    <script src="${base}/static/thridparty/jquery/jquery.min.js"></script>
    <script src="${base}/static/js/jq-watermark.js"></script>
    <script src="${base}/static/js/DD_belatedPNG_0.0.8a-min.js"></script>
</head>
...
<div class="bodyBg">
    <div class="loginContent">
        ...
        <div class="LoginPosition">
            ...
            <!-- 版权 -->
            <footer class="footer">
                <p class="Copyright">Copyright © 苏州工业园区国土环保局、苏州工业园区土地储备中心 版权所有 最佳浏览效果:IE8.0版本以上 1024*768分辨率 </p>
            </footer>
            <!--end 版权 -->
        </div>
    ...
    <script>
        function btnSubmit(){
            ...
            if(result==true){
                ...
                $('#serialNumber').val(gtmapCA.getCertificateSerialNumber());
