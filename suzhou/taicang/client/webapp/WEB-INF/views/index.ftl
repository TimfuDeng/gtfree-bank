...
<div class="wp">
        ...
        <table class="table table-border table-bordered" style="margin-top:20px">
            <tr>
                ...
                <td class="va-m">
                    ...
                    <span class="label <@OutClassValue obj=param.useType! value='GKCCYD' classValue='label-danger' defaultValue='label-none'/>">
                         <a href="#" onclick="submitValue('useType','GKCCYD')">
                        工业
                         </a>
                    </span>
        ...
        <form id="frmSearch" method="get">
            ...
            <table class="table table-border table-bordered" style="margin-top:20px;background-color: #f6f6f6;">
                <tr>
                    ...
                    <#--<td class="va-m" width="250">-->
                        <#--价格&nbsp;&nbsp;<input type="text"  class="input-text input-mini" style="width:90px;">-<input type="text" class="input-text input-mini" style="width:90px;">-->
                    <#--</td>-->
                    <td class="va-m">
                    <span>
    ...
    <#list transResourcePage.items as resource>
        <div class="col-3" style="padding-right:20px;padding-top:10px">
            <a href="${base}/view?id=${resource.resourceId}" target="frm_${resource.resourceId}" class="link-wrap" >
