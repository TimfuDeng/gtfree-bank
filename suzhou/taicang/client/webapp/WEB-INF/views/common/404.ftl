...
<head>
    ...
    <style>
        ...
        .page-404 .error-title, .page-404 .error-title .iconfont {
            font-size: 80px;
        }
...
<section class="page-404 minWP text-c">
    <p class="error-title"><i class="iconfont va-m">󰅎</i><span class="va-m"> 404</span></p>
    <p class="error-description">不好意思，您访问的页面不存在~</p>
    <p class="error-info">您可以：<a href="${base}/index" class="c-primary ml-20">去首页 &gt;</a></p>
</section>
